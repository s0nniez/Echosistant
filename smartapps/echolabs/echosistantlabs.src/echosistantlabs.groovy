 ...
 * Phase 3 - Security Module - Parent App - status COMPLETED
 * Phase 4 - Text to Speech Module (new add-on app Profile) - in PROGRESS
 * Phase 5 - Scenes Labs (new add-on app Scenes) - in PROGRESS
